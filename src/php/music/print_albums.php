...
while ($donnees = $requete->fetch()) {
    ...
    <div class="d-flex align-items-end" style="width:180px;height:100px;margin:auto;"><img src="./public/img/logo/'.$donnees['groupe'].'_LOGO.png" alt="" style="width:100%;"></div>
    <p class="mt-1" style="height:35px">'.$donnees['titre'].'</p>
